...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <x-toolbar-list title="Clientes" subTitle="" type="Lista" />
            ...
            <div class="app-container container-xxl">
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        ...
                        <x-search-header placeholder="Buscar Cliente" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('clientes.show', $customer->id) }}"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $customer->name . ' ' . $customer->last_name }}</a>
                                        </td>
                                        <td>{{ $customer->user }}</td>
                                        <td>{{ $customer->email }}</td>
                                        <td>
                                            <div
                                                class="badge {{ $customer->status == 'Ativo' ? 'badge-light-success' : 'badge-light-danger' }}">
                                                {{ $customer->status }}
                                            </div>
                                        </td>
                                        <td>{{ $customer->created_at ? $customer->created_at->format('d M Y, g:i a') : 'N/A' }}
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('clientes.edit', $customer->id) }}"
                                                        class="menu-link px-3">Editar</a>
                                                </div>

                                                <form class="menu-item px-3 sweetalert-delete"
                                                    action="{{ route('clientes.destroy', $customer->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
...
@section('ajax-status')
    ...
    <script type="text/javascript">
        ...
        var KTUsersList = (function() {
            ...
            var tableElement = document.getElementById("kt_table");

            var initTable = function() {
                const checkboxes = tableElement.querySelectorAll('[type="checkbox"]');
                var baseToolbar = document.querySelector('[data-kt-table-toolbar="base"]');
                var selectedToolbar = document.querySelector('[data-kt-table-toolbar="selected"]');
                var selectedCountElement = document.querySelector('[data-kt-table-select="selected_count"]');
