            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <form id="kt_modal_export_users_form" class="form" method="POST">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <select id="formatoExportacao" name="format" data-control="select2" data-placeholder="Selecione o formato" data-hide-search="true" class="form-select form-select-solid fw-bold">
                            <option></option>
