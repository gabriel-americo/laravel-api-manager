                        ...
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-13" placeholder="Buscar Usuario" />
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('usuarios.show', $usuario->id) }}"
                                                    class="text-gray-800 text-hover-primary mb-1">{{ $usuario->nome }}</a>
                                        ...
                                        <td>
                                            @foreach ($usuario->roles as $role)
                                                <div class="badge badge-light fw-bold">{{ $role->nome }}</div>
                                            @endforeach
                                        </td>
                                        <td>
                                            <div
                                                class="badge {{ $usuario->status == 'Ativo' ? 'badge-light-success' : 'badge-light-danger' }}">
                                                {{ $usuario->status }}
                                            </div>
                                        </td>
                                        <td>{{ $usuario->ultimo_login ? $usuario->ultimo_login->format('d M Y, g:i a') : 'N/A' }}
                                        </td>
