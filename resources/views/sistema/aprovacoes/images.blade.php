                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted text-hover-primary">Imagens da Aprovação</a>
                        </li>
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>Imagens das Aprovações</h2>
                                </div>
                            </div>

                            <div class="card-body pt-0">
                                <form class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                    action="{{ route('aprovacoes-imagens.upload-imagem') }}" method="post"
                                ...
                                <div class="text-muted fs-7">Coloque as imagens da aprovação.</div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="mb-0">
                                    <h1 class="text-dark mb-10">Imagens para Aprovação</h1>
    ...
    <script>
        $(function() {
            ...
            const saveLegend = (id, legenda) => {
                ajaxCall("POST", "{{ route('aprovacoes-imagens.create-subtitle') }}", {
                    'legenda': legenda,
                    'idImagem': id
