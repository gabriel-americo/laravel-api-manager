        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Aprovações
                    </h1>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-table-toolbar="base">
                                ...
                                <a href="{{ route('aprovacoes.create') }}" type="button" class="btn btn-primary">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Ideia</th>
                                    <th class="min-w-125px">Aprovado</th>
                                    <th class="min-w-125px text-center">Imagens</th>
                                ...
                                @foreach ($aprovacoes as $aprovacao)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('aprovacoes.images', $aprovacao->id) }}">
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('aprovacoes.edit', $aprovacao->id) }}"
                                                        class="menu-link px-3">Editar</a>
                                                </div>

                                                <form class="menu-item px-3 sweetalert-delete"
                                                    action="{{ route('aprovacoes.destroy', $aprovacao->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
